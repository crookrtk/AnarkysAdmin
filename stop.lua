...
getgenv().themes = {
    dark = {
            ...
            suggestionBackFrameColor = rgb(33, 33, 33),
            ...
            scrollBackImageColor = rgb(33, 33, 33),
...
gadmin.load = function(thm,title,btcmds)
    ...
    admin.addCommand({name = 'test',desc = 'wtuhadhas',callback = function()
        setclipboard('heehee')
